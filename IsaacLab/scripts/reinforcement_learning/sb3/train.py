...
from video_callback import IsaacLabVideoCallback
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: dict):
    ...
    # NOTE: video recording is handled by a callback (after Sb3VecEnvWrapper)
    # instead of gym.wrappers.RecordVideo, which gets bypassed by fast_variant.
