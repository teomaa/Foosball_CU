...
# All rights reserved.
#This is before I attempt to have prisimatic and revolute have different action scales
...
class FoosballEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: FoosballEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        for joint_name in black_joint_names:
            self.black_dof_indices.append(self.robot.joint_names.index(joint_name))
    ...
    def _pre_physics_step(self, actions: torch.Tensor) -> None:
        actions = torch.clamp(actions.clone(), -1.0, 1.0)
...
def compute_rewards(
    ...
    total_reward=score+dist_reward
